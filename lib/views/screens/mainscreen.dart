...
import 'package:homestay/views/screens/clienthomestaydetail.dart';
...
//for pagination
              ...
              : Column(
                  children: [
                    Padding(
                      ...
                      child: Text(
                        "Home stay/services ($numberofresult found)",
                        style: const TextStyle(
    ...
    Timer(const Duration(seconds: 1), () {
      if (rental != null) {
        ...
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (content) => ClientHomestayDetail(
                      user: widget.user,
                      homestay: homestay,
                      rental: rental,
                    )));
  ...
  loadSingleSeller(int index) {
    http.post(Uri.parse("${ServerConfig.SERVER}/php/load_rental.php"),
        body: {"rentalid": homestayList[index].userId}).then((response) {
      print(response.body);
      var jsonResponse = json.decode(response.body);
      if (response.statusCode == 200 && jsonResponse['status'] == "success") {
        rental = User.fromJson(jsonResponse['data']);
      }
    });
  }
}