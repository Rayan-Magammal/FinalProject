...
class ClientHomestayDetail extends StatefulWidget {
  final Homestay homestay;
  final User user;
  final User rental;
  const ClientHomestayDetail({super.key,
  required this.homestay,
      required this.user,
      required this.rental});

  @override
  State<ClientHomestayDetail> createState() => _ClientHomestayDetailState();
}

class _ClientHomestayDetailState extends State<ClientHomestayDetail> {
              ...
              Card(
                ...
                child: Container(
                    ...
                    child: CachedNetworkImage(
                      ...
                      fit: BoxFit.cover,
                      imageUrl:
                          "${ServerConfig.SERVER}/assets/homestayimages/${widget.homestay.homestayId}.2.png",
                      placeholder: (context, url) => const LinearProgressIndicator(),
                      errorWidget: (context, url, error) => const Icon(Icons.error),
                    )),
              ),
        ...
        Card(
              ...
              child: Container(
                  ...
                  child: CachedNetworkImage(
                    ...
                    fit: BoxFit.cover,
                    imageUrl:
                        "${ServerConfig.SERVER}/assets/homestayimages/${widget.homestay.homestayId}.3.png",
                    placeholder: (context, url) => const LinearProgressIndicator(),
                    errorWidget: (context, url, error) => const Icon(Icons.error),
                  )),
            ),
              ...
              children: [
                ...
                TableRow(children: [
                  Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: const [
                        Text('Price Per Night', style: TextStyle(fontSize: 20.0))
                      ]),
                  Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                ...
                TableRow(children: [
                  Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: const [
                        Text('No of Rooms', style: TextStyle(fontSize: 20.0))
                      ]),
                  Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("${widget.homestay.noRoom}",
                            style: const TextStyle(fontSize: 20.0))
                      ]),
                ]),
                TableRow(children: [
  ...
  openwhatsapp() async {
    var whatsapp = widget.rental.phone;
